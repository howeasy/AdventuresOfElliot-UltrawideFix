...
static_assert(offsetof(AAtomAreaSoundVolume, bEnableRepeatPlayWhenSoundStop) == 0x000271, "Member 'AAtomAreaSoundVolume::bEnableRepeatPlayWhenSoundStop' has a wrong offset!");
...
public:
	...
	TMulticastInlineDelegate<void(int32 BlockIndex)> OnAtomSoundCueBlockIndexChanged;                   // 0x02A0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	class UWorld*                                 PlayWorld;                                         // 0x02B0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UGameViewportClient*                    GameViewport;                                      // 0x02B8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2C0[0x28];                                     // 0x02C0(0x0028)(Fixing Size After Last Property [ Dumper-7 ])
	class UAtomSoundObject*                       DefaultSoundObject;                                // 0x02E8(0x0008)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bOverrideAttenuation : 1;                          // 0x02F0(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	...
	struct FSoundAttenuationSettings              AttenuationOverrides;                              // 0x0300(0x03A0)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	uint8                                         Pad_6A0[0xAF0];                                    // 0x06A0(0x0AF0)(Fixing Size After Last Property [ Dumper-7 ])
	class USoundAtomCueSheet*                     CueSheet;                                          // 0x1190(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1198[0x10];                                    // 0x1198(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	class UAtomSoundObject*                       AppliedSoundObject;                                // 0x11A8(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_11B0[0x20];                                    // 0x11B0(0x0020)(Fixing Size After Last Property [ Dumper-7 ])
	TMulticastInlineDelegate<void(class UAtomComponent* AtomComponent, struct FAtomBeatSyncInfo& BeatSyncInfo)> OnAtomBeatSyncCallback;                            // 0x11D0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(class UAtomComponent* AtomComponent, struct FAtomSequenceInfo& SequenceInfo)> OnAtomSequenceCallback;                            // 0x11E0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_11F0[0x80];                                    // 0x11F0(0x0080)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UAtomComponent) == 0x001270, "Wrong size on UAtomComponent");
...
static_assert(offsetof(UAtomComponent, bIsOverrideAisacControlSettingsWithVelocity) == 0x000250, "Member 'UAtomComponent::bIsOverrideAisacControlSettingsWithVelocity' has a wrong offset!");
static_assert(offsetof(UAtomComponent, OverrideAisacControlSettingsWithVelocity) == 0x000258, "Member 'UAtomComponent::OverrideAisacControlSettingsWithVelocity' has a wrong offset!");
static_assert(offsetof(UAtomComponent, LoopSetting) == 0x000268, "Member 'UAtomComponent::LoopSetting' has a wrong offset!");
static_assert(offsetof(UAtomComponent, OnStatusChanged) == 0x000270, "Member 'UAtomComponent::OnStatusChanged' has a wrong offset!");
static_assert(offsetof(UAtomComponent, OnAudioVolumeChanged) == 0x000280, "Member 'UAtomComponent::OnAudioVolumeChanged' has a wrong offset!");
static_assert(offsetof(UAtomComponent, OnAudioFinished) == 0x000290, "Member 'UAtomComponent::OnAudioFinished' has a wrong offset!");
static_assert(offsetof(UAtomComponent, OnAtomSoundCueBlockIndexChanged) == 0x0002A0, "Member 'UAtomComponent::OnAtomSoundCueBlockIndexChanged' has a wrong offset!");
static_assert(offsetof(UAtomComponent, PlayWorld) == 0x0002B0, "Member 'UAtomComponent::PlayWorld' has a wrong offset!");
static_assert(offsetof(UAtomComponent, GameViewport) == 0x0002B8, "Member 'UAtomComponent::GameViewport' has a wrong offset!");
static_assert(offsetof(UAtomComponent, DefaultSoundObject) == 0x0002E8, "Member 'UAtomComponent::DefaultSoundObject' has a wrong offset!");
static_assert(offsetof(UAtomComponent, AttenuationSettings) == 0x0002F8, "Member 'UAtomComponent::AttenuationSettings' has a wrong offset!");
static_assert(offsetof(UAtomComponent, AttenuationOverrides) == 0x000300, "Member 'UAtomComponent::AttenuationOverrides' has a wrong offset!");
static_assert(offsetof(UAtomComponent, CueSheet) == 0x001190, "Member 'UAtomComponent::CueSheet' has a wrong offset!");
static_assert(offsetof(UAtomComponent, AppliedSoundObject) == 0x0011A8, "Member 'UAtomComponent::AppliedSoundObject' has a wrong offset!");
static_assert(offsetof(UAtomComponent, OnAtomBeatSyncCallback) == 0x0011D0, "Member 'UAtomComponent::OnAtomBeatSyncCallback' has a wrong offset!");
static_assert(offsetof(UAtomComponent, OnAtomSequenceCallback) == 0x0011E0, "Member 'UAtomComponent::OnAtomSequenceCallback' has a wrong offset!");
...
public:
	...
	TMulticastInlineDelegate<void(class USoundAtomCue* PlayingAtomCue, int32 WaveId, float PlaybackPercent)> OnWavePlaybackPercent;                             // 0x0068(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
public:
	uint8                                         Pad_28[0x8];                                       // 0x0028(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	TMulticastInlineDelegate<void(struct FCriWareErrorInfo& ErrorInfo)> OnCriWareError;                                    // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
public:
	...
	struct FSoftObjectPath                        AtomOutputPortDataTable;                           // 0x01B8(0x0018)(Edit, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1D0[0x18];                                     // 0x01D0(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         DistanceFactor;                                    // 0x01E8(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1EC[0x4];                                      // 0x01EC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	EAtomSoundRendererType                        SoundRendererTypeUI;                               // 0x01F0(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1F1[0x3];                                      // 0x01F1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         SoundRendererType;                                 // 0x01F4(0x0004)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1F8[0x8];                                      // 0x01F8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FAtomAsrRackConfigUI>           AsrRackConfigUI;                                   // 0x0200(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FAtomAsrRackConfig>             AsrRackConfig;                                     // 0x0210(0x0010)(ZeroConstructor, Config, NativeAccessSpecifierPublic)
	uint8                                         Pad_220[0x10];                                     // 0x0220(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 Hardware1;                                         // 0x0230(0x0010)(ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 Hardware2;                                         // 0x0240(0x0010)(ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 Hardware3;                                         // 0x0250(0x0010)(ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 Hardware4;                                         // 0x0260(0x0010)(ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         EconomicTickMarginDistance;                        // 0x0270(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_274[0x4];                                      // 0x0274(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         EconomicTickFrequency;                             // 0x0278(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_27C[0x4];                                      // 0x027C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         CullingMarginDistance;                             // 0x0280(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_284[0x4];                                      // 0x0284(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          EnableDirectDbasConfig;                            // 0x0288(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_289[0x3];                                      // 0x0289(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         DbasIdentifier;                                    // 0x028C(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_290[0x4];                                      // 0x0290(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         DbasMaxStreams;                                    // 0x0294(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_298[0x4];                                      // 0x0298(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         DbasMaxBps;                                        // 0x029C(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2A0[0x4];                                      // 0x02A0(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         DbasMaxManaStreams;                                // 0x02A4(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2A8[0x4];                                      // 0x02A8(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         DbasMaxManaBps;                                    // 0x02AC(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2B0[0x4];                                      // 0x02B0(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         DbasNumSecurementBuffers;                          // 0x02B4(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2B8[0x4];                                      // 0x02B8(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         HcaMxVoiceSamplingRate;                            // 0x02BC(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2C0[0x4];                                      // 0x02C0(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         NumHcaMxMemoryVoices;                              // 0x02C4(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2C8[0x4];                                      // 0x02C8(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         HcaMxMemoryVoiceNumChannels;                       // 0x02CC(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2D0[0x4];                                      // 0x02D0(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         NumHcaMxStreamingVoices;                           // 0x02D4(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2D8[0x4];                                      // 0x02D8(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         HcaMxStreamingVoiceNumChannels;                    // 0x02DC(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2E0[0x4];                                      // 0x02E0(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          WASAPI_IsExclusive;                                // 0x02E4(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2E5[0x3];                                      // 0x02E5(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         WASAPI_BitsPerSample;                              // 0x02E8(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2EC[0x4];                                      // 0x02EC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         WASAPI_SamplingRate;                               // 0x02F0(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2F4[0x4];                                      // 0x02F4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         WASAPI_NumChannels;                                // 0x02F8(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2FC[0x4];                                      // 0x02FC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          UseUnrealSoundRenderer;                            // 0x0300(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_301[0x1];                                      // 0x0301(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          SmartPhone_UseSonicSYNC;                           // 0x0302(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_303[0x1];                                      // 0x0303(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         PS4_ServerThreadAffinityMask;                      // 0x0304(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_308[0x4];                                      // 0x0308(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         PS4_OutputThreadAffinityMask;                      // 0x030C(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_310[0x4];                                      // 0x0310(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         PS4_ServerThreadPriority;                          // 0x0314(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_318[0x4];                                      // 0x0318(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         PS4_OutputThreadPriority;                          // 0x031C(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_320[0x4];                                      // 0x0320(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          PS4_UseAudio3d;                                    // 0x0324(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_325[0x3];                                      // 0x0325(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         PS4_NumberOfAudio3dMemoryVoices;                   // 0x0328(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_32C[0x4];                                      // 0x032C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         PS4_SamplingRateOfAudio3dMemoryVoices;             // 0x0330(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_334[0x4];                                      // 0x0334(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         PS4_NumberOfAudio3dStreamingVoices;                // 0x0338(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_33C[0x4];                                      // 0x033C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         PS4_SamplingRateOfAudio3dStreamingVoices;          // 0x0340(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_344[0x4];                                      // 0x0344(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         Switch_NumOpusMemoryVoices;                        // 0x0348(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_34C[0x4];                                      // 0x034C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         Switch_OpusMemoryVoiceNumChannels;                 // 0x0350(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_354[0x4];                                      // 0x0354(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         Switch_OpusMemoryVoiceSamplingRate;                // 0x0358(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_35C[0x4];                                      // 0x035C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         Switch_NumOpusStreamingVoices;                     // 0x0360(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_364[0x4];                                      // 0x0364(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         Switch_OpusStreamingVoiceNumChannels;              // 0x0368(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_36C[0x4];                                      // 0x036C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         Switch_OpusStreamingVoiceSamplingRate;             // 0x0370(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_374[0x4];                                      // 0x0374(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          InitializeMana;                                    // 0x0378(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_379[0x1];                                      // 0x0379(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          EnableDecodeSkip;                                  // 0x037A(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_37B[0x1];                                      // 0x037B(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         MaxDecoderHandles;                                 // 0x037C(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_380[0x4];                                      // 0x0380(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         MaxManaBPS;                                        // 0x0384(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_388[0x4];                                      // 0x0388(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         MaxManaStreams;                                    // 0x038C(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_390[0x4];                                      // 0x0390(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          UseH264Decoder;                                    // 0x0394(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_395[0x1];                                      // 0x0395(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          UseDecoderOutputBuffers;                           // 0x0396(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_397[0x1];                                      // 0x0397(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          ForceSoftwareDecodingOnXboxOne;                    // 0x0398(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_399[0x1];                                      // 0x0399(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          ForceSoftwareDecodingOnXboxSeries;                 // 0x039A(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_39B[0x1];                                      // 0x039B(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          ForceDisableManaStreamerManager;                   // 0x039C(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_39D[0x1];                                      // 0x039D(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          InitializeAdxLipSync;                              // 0x039E(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_39F[0x1];                                      // 0x039F(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         MaxNumAnalyzerHandles;                             // 0x03A0(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_3A4[0x4];                                      // 0x03A4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bUseManaStartupMovies;                             // 0x03A8(0x0001)(Edit, ZeroConstructor, Config, GlobalConfig, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bWaitForMoviesToComplete;                          // 0x03A9(0x0001)(Edit, ZeroConstructor, Config, GlobalConfig, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bMoviesAreSkippable;                               // 0x03AA(0x0001)(Edit, ZeroConstructor, Config, GlobalConfig, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UCriWarePluginSettings, AtomOutputPortDataTable) == 0x0001B8, "Member 'UCriWarePluginSettings::AtomOutputPortDataTable' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, DistanceFactor) == 0x0001E8, "Member 'UCriWarePluginSettings::DistanceFactor' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, SoundRendererTypeUI) == 0x0001F0, "Member 'UCriWarePluginSettings::SoundRendererTypeUI' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, SoundRendererType) == 0x0001F4, "Member 'UCriWarePluginSettings::SoundRendererType' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, AsrRackConfigUI) == 0x000200, "Member 'UCriWarePluginSettings::AsrRackConfigUI' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, AsrRackConfig) == 0x000210, "Member 'UCriWarePluginSettings::AsrRackConfig' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, Hardware1) == 0x000230, "Member 'UCriWarePluginSettings::Hardware1' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, Hardware2) == 0x000240, "Member 'UCriWarePluginSettings::Hardware2' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, Hardware3) == 0x000250, "Member 'UCriWarePluginSettings::Hardware3' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, Hardware4) == 0x000260, "Member 'UCriWarePluginSettings::Hardware4' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, EconomicTickMarginDistance) == 0x000270, "Member 'UCriWarePluginSettings::EconomicTickMarginDistance' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, EconomicTickFrequency) == 0x000278, "Member 'UCriWarePluginSettings::EconomicTickFrequency' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, CullingMarginDistance) == 0x000280, "Member 'UCriWarePluginSettings::CullingMarginDistance' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, EnableDirectDbasConfig) == 0x000288, "Member 'UCriWarePluginSettings::EnableDirectDbasConfig' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, DbasIdentifier) == 0x00028C, "Member 'UCriWarePluginSettings::DbasIdentifier' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, DbasMaxStreams) == 0x000294, "Member 'UCriWarePluginSettings::DbasMaxStreams' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, DbasMaxBps) == 0x00029C, "Member 'UCriWarePluginSettings::DbasMaxBps' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, DbasMaxManaStreams) == 0x0002A4, "Member 'UCriWarePluginSettings::DbasMaxManaStreams' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, DbasMaxManaBps) == 0x0002AC, "Member 'UCriWarePluginSettings::DbasMaxManaBps' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, DbasNumSecurementBuffers) == 0x0002B4, "Member 'UCriWarePluginSettings::DbasNumSecurementBuffers' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, HcaMxVoiceSamplingRate) == 0x0002BC, "Member 'UCriWarePluginSettings::HcaMxVoiceSamplingRate' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, NumHcaMxMemoryVoices) == 0x0002C4, "Member 'UCriWarePluginSettings::NumHcaMxMemoryVoices' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, HcaMxMemoryVoiceNumChannels) == 0x0002CC, "Member 'UCriWarePluginSettings::HcaMxMemoryVoiceNumChannels' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, NumHcaMxStreamingVoices) == 0x0002D4, "Member 'UCriWarePluginSettings::NumHcaMxStreamingVoices' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, HcaMxStreamingVoiceNumChannels) == 0x0002DC, "Member 'UCriWarePluginSettings::HcaMxStreamingVoiceNumChannels' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, WASAPI_IsExclusive) == 0x0002E4, "Member 'UCriWarePluginSettings::WASAPI_IsExclusive' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, WASAPI_BitsPerSample) == 0x0002E8, "Member 'UCriWarePluginSettings::WASAPI_BitsPerSample' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, WASAPI_SamplingRate) == 0x0002F0, "Member 'UCriWarePluginSettings::WASAPI_SamplingRate' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, WASAPI_NumChannels) == 0x0002F8, "Member 'UCriWarePluginSettings::WASAPI_NumChannels' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, UseUnrealSoundRenderer) == 0x000300, "Member 'UCriWarePluginSettings::UseUnrealSoundRenderer' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, SmartPhone_UseSonicSYNC) == 0x000302, "Member 'UCriWarePluginSettings::SmartPhone_UseSonicSYNC' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, PS4_ServerThreadAffinityMask) == 0x000304, "Member 'UCriWarePluginSettings::PS4_ServerThreadAffinityMask' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, PS4_OutputThreadAffinityMask) == 0x00030C, "Member 'UCriWarePluginSettings::PS4_OutputThreadAffinityMask' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, PS4_ServerThreadPriority) == 0x000314, "Member 'UCriWarePluginSettings::PS4_ServerThreadPriority' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, PS4_OutputThreadPriority) == 0x00031C, "Member 'UCriWarePluginSettings::PS4_OutputThreadPriority' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, PS4_UseAudio3d) == 0x000324, "Member 'UCriWarePluginSettings::PS4_UseAudio3d' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, PS4_NumberOfAudio3dMemoryVoices) == 0x000328, "Member 'UCriWarePluginSettings::PS4_NumberOfAudio3dMemoryVoices' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, PS4_SamplingRateOfAudio3dMemoryVoices) == 0x000330, "Member 'UCriWarePluginSettings::PS4_SamplingRateOfAudio3dMemoryVoices' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, PS4_NumberOfAudio3dStreamingVoices) == 0x000338, "Member 'UCriWarePluginSettings::PS4_NumberOfAudio3dStreamingVoices' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, PS4_SamplingRateOfAudio3dStreamingVoices) == 0x000340, "Member 'UCriWarePluginSettings::PS4_SamplingRateOfAudio3dStreamingVoices' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, Switch_NumOpusMemoryVoices) == 0x000348, "Member 'UCriWarePluginSettings::Switch_NumOpusMemoryVoices' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, Switch_OpusMemoryVoiceNumChannels) == 0x000350, "Member 'UCriWarePluginSettings::Switch_OpusMemoryVoiceNumChannels' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, Switch_OpusMemoryVoiceSamplingRate) == 0x000358, "Member 'UCriWarePluginSettings::Switch_OpusMemoryVoiceSamplingRate' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, Switch_NumOpusStreamingVoices) == 0x000360, "Member 'UCriWarePluginSettings::Switch_NumOpusStreamingVoices' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, Switch_OpusStreamingVoiceNumChannels) == 0x000368, "Member 'UCriWarePluginSettings::Switch_OpusStreamingVoiceNumChannels' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, Switch_OpusStreamingVoiceSamplingRate) == 0x000370, "Member 'UCriWarePluginSettings::Switch_OpusStreamingVoiceSamplingRate' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, InitializeMana) == 0x000378, "Member 'UCriWarePluginSettings::InitializeMana' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, EnableDecodeSkip) == 0x00037A, "Member 'UCriWarePluginSettings::EnableDecodeSkip' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, MaxDecoderHandles) == 0x00037C, "Member 'UCriWarePluginSettings::MaxDecoderHandles' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, MaxManaBPS) == 0x000384, "Member 'UCriWarePluginSettings::MaxManaBPS' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, MaxManaStreams) == 0x00038C, "Member 'UCriWarePluginSettings::MaxManaStreams' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, UseH264Decoder) == 0x000394, "Member 'UCriWarePluginSettings::UseH264Decoder' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, UseDecoderOutputBuffers) == 0x000396, "Member 'UCriWarePluginSettings::UseDecoderOutputBuffers' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, ForceSoftwareDecodingOnXboxOne) == 0x000398, "Member 'UCriWarePluginSettings::ForceSoftwareDecodingOnXboxOne' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, ForceSoftwareDecodingOnXboxSeries) == 0x00039A, "Member 'UCriWarePluginSettings::ForceSoftwareDecodingOnXboxSeries' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, ForceDisableManaStreamerManager) == 0x00039C, "Member 'UCriWarePluginSettings::ForceDisableManaStreamerManager' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, InitializeAdxLipSync) == 0x00039E, "Member 'UCriWarePluginSettings::InitializeAdxLipSync' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, MaxNumAnalyzerHandles) == 0x0003A0, "Member 'UCriWarePluginSettings::MaxNumAnalyzerHandles' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, bUseManaStartupMovies) == 0x0003A8, "Member 'UCriWarePluginSettings::bUseManaStartupMovies' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, bWaitForMoviesToComplete) == 0x0003A9, "Member 'UCriWarePluginSettings::bWaitForMoviesToComplete' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, bMoviesAreSkippable) == 0x0003AA, "Member 'UCriWarePluginSettings::bMoviesAreSkippable' has a wrong offset!");
...
static_assert(sizeof(UManaComponent) == 0x0002A8, "Wrong size on UManaComponent");
...
static_assert(offsetof(UManaComponent, OnRequestData) == 0x000150, "Member 'UManaComponent::OnRequestData' has a wrong offset!");
static_assert(offsetof(UManaComponent, Playlist) == 0x0001A0, "Member 'UManaComponent::Playlist' has a wrong offset!");
static_assert(offsetof(UManaComponent, PlaylistIndex) == 0x0001A8, "Member 'UManaComponent::PlaylistIndex' has a wrong offset!");
static_assert(offsetof(UManaComponent, bLoop) == 0x0001B0, "Member 'UManaComponent::bLoop' has a wrong offset!");
static_assert(offsetof(UManaComponent, AlphaTrack) == 0x0001B4, "Member 'UManaComponent::AlphaTrack' has a wrong offset!");
static_assert(offsetof(UManaComponent, AudioTrack) == 0x0001B8, "Member 'UManaComponent::AudioTrack' has a wrong offset!");
static_assert(offsetof(UManaComponent, SubAudioTrack) == 0x0001BC, "Member 'UManaComponent::SubAudioTrack' has a wrong offset!");
static_assert(offsetof(UManaComponent, ExtraAudioTrack) == 0x0001C0, "Member 'UManaComponent::ExtraAudioTrack' has a wrong offset!");
static_assert(offsetof(UManaComponent, AudioCategoryName) == 0x0001C8, "Member 'UManaComponent::AudioCategoryName' has a wrong offset!");
static_assert(offsetof(UManaComponent, SubAudioCategoryName) == 0x0001D8, "Member 'UManaComponent::SubAudioCategoryName' has a wrong offset!");
static_assert(offsetof(UManaComponent, ExtraAudioCategoryName) == 0x0001E8, "Member 'UManaComponent::ExtraAudioCategoryName' has a wrong offset!");
static_assert(offsetof(UManaComponent, bSubtitlesEnabled) == 0x0001F8, "Member 'UManaComponent::bSubtitlesEnabled' has a wrong offset!");
static_assert(offsetof(UManaComponent, SubtitlesChannel) == 0x0001FC, "Member 'UManaComponent::SubtitlesChannel' has a wrong offset!");
static_assert(offsetof(UManaComponent, SubtitlesEncoding) == 0x000200, "Member 'UManaComponent::SubtitlesEncoding' has a wrong offset!");
static_assert(offsetof(UManaComponent, EndFrameAction) == 0x000201, "Member 'UManaComponent::EndFrameAction' has a wrong offset!");
static_assert(offsetof(UManaComponent, PlaybackTimer) == 0x000202, "Member 'UManaComponent::PlaybackTimer' has a wrong offset!");
static_assert(offsetof(UManaComponent, MaxFrameDrop) == 0x000203, "Member 'UManaComponent::MaxFrameDrop' has a wrong offset!");
...
public:
	...
	uint8                                         bEnableSpatialization : 1;                         // 0x01F8(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverrideVolumeMultiplier : 1;                     // 0x01F8(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bEnableLowPassFilter : 1;                          // 0x01F8(0x0001)(BitIndex: 0x04, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_1F9[0x3];                                      // 0x01F9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         VolumeMultiplier;                                  // 0x01FC(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         LowPassFilterFrequency;                            // 0x0200(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         PanSpread;                                         // 0x0204(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MinAttenuationDistance;                            // 0x0208(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MaxAttenuationDistance;                            // 0x020C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FAtomAisacControlParam>         AisacControls;                                     // 0x0210(0x0010)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<class FString>                         AttachedAisacs;                                    // 0x0220(0x0010)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	class FString                                 AudioTrackCategory;                                // 0x0230(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 SubAudioTrackCategory;                             // 0x0240(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 ExtraAudioTrackCategory;                           // 0x0250(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UManaPlayer*                            ManaPlayer;                                        // 0x0260(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UManaSoundComponent) == 0x0002A0, "Wrong size on UManaSoundComponent");
static_assert(offsetof(UManaSoundComponent, VolumeMultiplier) == 0x0001FC, "Member 'UManaSoundComponent::VolumeMultiplier' has a wrong offset!");
static_assert(offsetof(UManaSoundComponent, LowPassFilterFrequency) == 0x000200, "Member 'UManaSoundComponent::LowPassFilterFrequency' has a wrong offset!");
static_assert(offsetof(UManaSoundComponent, PanSpread) == 0x000204, "Member 'UManaSoundComponent::PanSpread' has a wrong offset!");
static_assert(offsetof(UManaSoundComponent, MinAttenuationDistance) == 0x000208, "Member 'UManaSoundComponent::MinAttenuationDistance' has a wrong offset!");
static_assert(offsetof(UManaSoundComponent, MaxAttenuationDistance) == 0x00020C, "Member 'UManaSoundComponent::MaxAttenuationDistance' has a wrong offset!");
static_assert(offsetof(UManaSoundComponent, AisacControls) == 0x000210, "Member 'UManaSoundComponent::AisacControls' has a wrong offset!");
static_assert(offsetof(UManaSoundComponent, AttachedAisacs) == 0x000220, "Member 'UManaSoundComponent::AttachedAisacs' has a wrong offset!");
static_assert(offsetof(UManaSoundComponent, AudioTrackCategory) == 0x000230, "Member 'UManaSoundComponent::AudioTrackCategory' has a wrong offset!");
static_assert(offsetof(UManaSoundComponent, SubAudioTrackCategory) == 0x000240, "Member 'UManaSoundComponent::SubAudioTrackCategory' has a wrong offset!");
static_assert(offsetof(UManaSoundComponent, ExtraAudioTrackCategory) == 0x000250, "Member 'UManaSoundComponent::ExtraAudioTrackCategory' has a wrong offset!");
static_assert(offsetof(UManaSoundComponent, ManaPlayer) == 0x000260, "Member 'UManaSoundComponent::ManaPlayer' has a wrong offset!");
