...
{
public:
	EFlipbookDirectionType                        CurrentDirectionType;                              // 0x0028(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_29[0x7];                                       // 0x0029(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FPaperFlipbookNotifyInfo>       NotifyInfos;                                       // 0x0030(0x0010)(Edit, ZeroConstructor, Protected, NativeAccessSpecifierProtected)
...
public:
	TArray<struct FPaperFlipbookNotifyInfo> GetNotifyInfosEditable();
	void SemiDeepCopyOnlyNotify(const class UPaperFlipbook* Src);
	void SetSpriteDirection(EFlipbookDirectionType NewDirection);
	...
	EFlipbookDirectionType GetSpriteDirection() const;
	float GetTotalDuration() const;
	bool IsValidDirection(EFlipbookDirectionType Direction) const;
...
static_assert(offsetof(UPaperFlipbook, CurrentDirectionType) == 0x000028, "Member 'UPaperFlipbook::CurrentDirectionType' has a wrong offset!");
static_assert(offsetof(UPaperFlipbook, NotifyInfos) == 0x000030, "Member 'UPaperFlipbook::NotifyInfos' has a wrong offset!");
...
public:
	...
	TMulticastInlineDelegate<void()>              onFinishedPlaying;                                 // 0x04B8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	EFlipbookDirectionType                        CachedDirection;                                   // 0x04C8(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	EFlipbookDirectionType                        CurrentDirectionType;                              // 0x04C9(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(UPaperFlipbookComponent, CachedDirection) == 0x0004C8, "Member 'UPaperFlipbookComponent::CachedDirection' has a wrong offset!");
static_assert(offsetof(UPaperFlipbookComponent, CurrentDirectionType) == 0x0004C9, "Member 'UPaperFlipbookComponent::CurrentDirectionType' has a wrong offset!");

// Class Paper2D.PaperFlipbookNotify
// 0x0008 (0x0030 - 0x0028)
class UPaperFlipbookNotify : public UObject
{
public:
	uint8                                         Pad_28[0x8];                                       // 0x0028(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void DeepCopy(const class UPaperFlipbookNotify* SrcObject);

	void ReceiveNotify(class UPaperFlipbookComponent* PaperFlipbookComponent) const;

public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"PaperFlipbookNotify">();
	}
	static class UPaperFlipbookNotify* GetDefaultObj()
	{
		return GetDefaultObjImpl<UPaperFlipbookNotify>();
	}
};
static_assert(alignof(UPaperFlipbookNotify) == 0x000008, "Wrong alignment on UPaperFlipbookNotify");
static_assert(sizeof(UPaperFlipbookNotify) == 0x000030, "Wrong size on UPaperFlipbookNotify");
...
public:
	...
	struct FVector2D                              CustomPivotPoint;                                  // 0x00A8(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(offsetof(UPaperSprite, CustomPivotPoint) == 0x0000A8, "Member 'UPaperSprite::CustomPivotPoint' has a wrong offset!");
