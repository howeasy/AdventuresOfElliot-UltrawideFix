...
public:
	...
	bool                                          enforceUpdate;                                     // 0x005C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(UMovieSceneSequence, enforceUpdate) == 0x00005C, "Member 'UMovieSceneSequence::enforceUpdate' has a wrong offset!");
