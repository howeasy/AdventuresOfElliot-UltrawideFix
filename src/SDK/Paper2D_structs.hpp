...
// Enum Paper2D.EFlipbookDirectionType
// NumValues: 0x0009
...
// ScriptStruct Paper2D.PaperSpriteSocketMap
// 0x0050 (0x0050 - 0x0000)
struct FPaperSpriteSocketMap final
{
public:
	TMap<class FName, struct FPaperSpriteSocket>  Sockets;                                           // 0x0000(0x0050)(NativeAccessSpecifierPublic)
};
static_assert(alignof(FPaperSpriteSocketMap) == 0x000008, "Wrong alignment on FPaperSpriteSocketMap");
static_assert(sizeof(FPaperSpriteSocketMap) == 0x000050, "Wrong size on FPaperSpriteSocketMap");
static_assert(offsetof(FPaperSpriteSocketMap, Sockets) == 0x000000, "Member 'FPaperSpriteSocketMap::Sockets' has a wrong offset!");
...
public:
	...
	TMap<EFlipbookDirectionType, class UPaperSprite*> Sprites;                                           // 0x0008(0x0050)(Edit, NativeAccessSpecifierPublic)
	TMap<EFlipbookDirectionType, struct FPaperSpriteSocketMap> SpriteSockets;                                     // 0x0058(0x0050)(NativeAccessSpecifierPublic)
	int32                                         FrameRun;                                          // 0x00A8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_AC[0x4];                                       // 0x00AC(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FPaperFlipbookKeyFrame) == 0x000008, "Wrong alignment on FPaperFlipbookKeyFrame");
static_assert(sizeof(FPaperFlipbookKeyFrame) == 0x0000B0, "Wrong size on FPaperFlipbookKeyFrame");
static_assert(offsetof(FPaperFlipbookKeyFrame, Sprite) == 0x000000, "Member 'FPaperFlipbookKeyFrame::Sprite' has a wrong offset!");
static_assert(offsetof(FPaperFlipbookKeyFrame, Sprites) == 0x000008, "Member 'FPaperFlipbookKeyFrame::Sprites' has a wrong offset!");
static_assert(offsetof(FPaperFlipbookKeyFrame, SpriteSockets) == 0x000058, "Member 'FPaperFlipbookKeyFrame::SpriteSockets' has a wrong offset!");
static_assert(offsetof(FPaperFlipbookKeyFrame, FrameRun) == 0x0000A8, "Member 'FPaperFlipbookKeyFrame::FrameRun' has a wrong offset!");

// ScriptStruct Paper2D.PaperFlipbookNotifyInfo
// 0x0018 (0x0018 - 0x0000)
struct FPaperFlipbookNotifyInfo final
{
public:
	class UPaperFlipbookNotify*                   Event;                                             // 0x0000(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	float                                         TriggerTimingFrame;                                // 0x0010(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_14[0x4];                                       // 0x0014(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FPaperFlipbookNotifyInfo) == 0x000008, "Wrong alignment on FPaperFlipbookNotifyInfo");
static_assert(sizeof(FPaperFlipbookNotifyInfo) == 0x000018, "Wrong size on FPaperFlipbookNotifyInfo");
static_assert(offsetof(FPaperFlipbookNotifyInfo, Event) == 0x000000, "Member 'FPaperFlipbookNotifyInfo::Event' has a wrong offset!");
static_assert(offsetof(FPaperFlipbookNotifyInfo, EventName) == 0x000008, "Member 'FPaperFlipbookNotifyInfo::EventName' has a wrong offset!");
static_assert(offsetof(FPaperFlipbookNotifyInfo, TriggerTimingFrame) == 0x000010, "Member 'FPaperFlipbookNotifyInfo::TriggerTimingFrame' has a wrong offset!");
