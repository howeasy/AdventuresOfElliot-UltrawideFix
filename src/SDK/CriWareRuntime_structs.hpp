...
// Enum CriWareRuntime.EAtomFaderCurve
// NumValues: 0x0006
...
static_assert(sizeof(FAtomProfileItem) == 0x000080, "Wrong size on FAtomProfileItem");
...
static_assert(offsetof(FAtomProfileItem, PlayedNumSamples) == 0x000030, "Member 'FAtomProfileItem::PlayedNumSamples' has a wrong offset!");
static_assert(offsetof(FAtomProfileItem, PlayerState) == 0x000038, "Member 'FAtomProfileItem::PlayerState' has a wrong offset!");
static_assert(offsetof(FAtomProfileItem, NumSounds) == 0x000048, "Member 'FAtomProfileItem::NumSounds' has a wrong offset!");
static_assert(offsetof(FAtomProfileItem, ConcurrencyName) == 0x000050, "Member 'FAtomProfileItem::ConcurrencyName' has a wrong offset!");
...
{
public:
	class UManaComponent*                         ManaComponent;                                     // 0x0000(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
