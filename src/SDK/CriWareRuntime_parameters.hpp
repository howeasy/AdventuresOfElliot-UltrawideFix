...
// 0x0001 (0x0001 - 0x0000)
struct AtomAsrRack_EnableBinauralizer final
{
public:
...
// 0x0001 (0x0001 - 0x0000)
struct AtomAsrRack_IsEnabledBinauralizer final
{
public:
	bool                                          ReturnValue;                                       // 0x0000(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
// 0x0004 (0x0004 - 0x0000)
struct AtomComponent_GetCurrentBlockIndex final
{
public:
	int32                                         ReturnValue;                                       // 0x0000(0x0004)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(AtomStatics_PlayAtomSoundForAnimNotify) == 0x0000B0, "Wrong size on AtomStatics_PlayAtomSoundForAnimNotify");
...
static_assert(offsetof(AtomStatics_PlayAtomSoundForAnimNotify, AttachToComponent) == 0x000068, "Member 'AtomStatics_PlayAtomSoundForAnimNotify::AttachToComponent' has a wrong offset!");
static_assert(offsetof(AtomStatics_PlayAtomSoundForAnimNotify, AttachPointName) == 0x000070, "Member 'AtomStatics_PlayAtomSoundForAnimNotify::AttachPointName' has a wrong offset!");
static_assert(offsetof(AtomStatics_PlayAtomSoundForAnimNotify, Location) == 0x000078, "Member 'AtomStatics_PlayAtomSoundForAnimNotify::Location' has a wrong offset!");
static_assert(offsetof(AtomStatics_PlayAtomSoundForAnimNotify, bStopWhenAttachedToDestroyed) == 0x000084, "Member 'AtomStatics_PlayAtomSoundForAnimNotify::bStopWhenAttachedToDestroyed' has a wrong offset!");
static_assert(offsetof(AtomStatics_PlayAtomSoundForAnimNotify, VolumeMultiplier) == 0x000088, "Member 'AtomStatics_PlayAtomSoundForAnimNotify::VolumeMultiplier' has a wrong offset!");
static_assert(offsetof(AtomStatics_PlayAtomSoundForAnimNotify, PitchMultiplier) == 0x00008C, "Member 'AtomStatics_PlayAtomSoundForAnimNotify::PitchMultiplier' has a wrong offset!");
static_assert(offsetof(AtomStatics_PlayAtomSoundForAnimNotify, StartTime) == 0x000090, "Member 'AtomStatics_PlayAtomSoundForAnimNotify::StartTime' has a wrong offset!");
static_assert(offsetof(AtomStatics_PlayAtomSoundForAnimNotify, AttenuationSettings) == 0x000098, "Member 'AtomStatics_PlayAtomSoundForAnimNotify::AttenuationSettings' has a wrong offset!");
static_assert(offsetof(AtomStatics_PlayAtomSoundForAnimNotify, bFollow) == 0x0000A0, "Member 'AtomStatics_PlayAtomSoundForAnimNotify::bFollow' has a wrong offset!");
static_assert(offsetof(AtomStatics_PlayAtomSoundForAnimNotify, ReturnValue) == 0x0000A8, "Member 'AtomStatics_PlayAtomSoundForAnimNotify::ReturnValue' has a wrong offset!");
...
{
public:
	class UManaPlayer*                            NewManaPlayer;                                     // 0x0000(0x0008)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
{
public:
	class UManaPlayer*                            ReturnValue;                                       // 0x0000(0x0008)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
